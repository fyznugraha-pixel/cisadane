      ...
      <div className="relative overflow-hidden border border-[#2654A4]/15 bg-white/95 shadow-xl backdrop-blur-xl">
        ...
        <div className="relative grid gap-4 p-4 md:grid-cols-[1fr_auto_36px] md:items-center md:gap-5 md:p-5">
          ...
          <div className="grid grid-cols-2 gap-3 md:flex md:items-center">
            ...
            <Link
              href={`/${lang}/register`}
              className="bg-[#FDB715] px-4 py-3 text-center text-[11px] font-black uppercase tracking-[0.16em] text-[#041020] shadow-hard transition hover:bg-[#2654A4] hover:text-white md:min-w-[170px]"
            >
              {dict.registerNow}
            </Link>
          </div>
